...
Predict Load of tommorrow at hour i based on last 7 days at time i, last 2 days at time i and yesterday at time i where $i\in {1,2,... 23}$
...
-Use more sophfisicated prediction methods (Neural Networks, or time series model)

-Optimize code, analyze data over several years instead of just one year

-Incorporate weather data from another source and see if that helps with prediction
